...
You can see the website live at: https://ankitrai26.github.io/SuperheroHunter/

This project is Super Hero Hunter  in which we use superheroAPI() to fetch the records and details of all the superheroes along with some additional features. It is built using HTML, CSS, Javascript.
